...
class BJCTopic
  ...
  llab = {}
  llab[:topic_keywords] = {}
  llab[:topic_keywords][:resources] = ["quiz", "assignment", "resource",
                                      "forum", "video", "extresource",
                                      "reading", "group"]
  llab[:topic_keywords][:headings] = ["h1", "h2", "h3", "h4", "h5", "h6", "heading"]
  llab[:topic_keywords][:info] = ["big-idea", "learning-goal"]
